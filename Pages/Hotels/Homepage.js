class Homepage {
    ...
    #signInLnk = '//button[text()="Sign in"]';
    #signUpLnk = '=Sign up, it’s free';
    ...
    async isChildBtnEnabled() {
        await $(this.#roomChildrenPlusLocatorStarts).waitForDisplayed();
        return $(this.#roomChildrenPlusLocatorStarts).isEnabled();
    }

    async isChildBtnEnabled() {
        await $(this.#roomChildrenMinusLocatorStarts).waitForDisplayed();
        return $(this.#roomChildrenMinusLocatorStarts).isEnabled();
    }

    
    async isChildPlusBtnDisabled() {
        await $(this.#roomChildrenPlusLocatorEnds).waitForDisplayed();
        return $(this.#roomChildrenPlusLocatorEnds).isDisabled();
    }
    
    async isChildMinusBtnDisabled() {
        await $(this.#roomChildrenMinusLocatorEnds).waitForDisplayed();
        return $(this.#roomChildrenMinusLocatorEnds).isDisabled();
    }
